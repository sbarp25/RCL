    ...
    <>
      <div className="bg-black text-white  w-full h-auto min-h-screen flex flex-col items-center justify-center px-4 md:px-12 py-8">
        ...
        <ul className="list-none mt-12 md:mt-24 p-0 flex flex-col md:flex-row flex-wrap items-center justify-center w-full space-y-6 md:space-y-0 md:space-x-6 gap-2">
          <li className="flex flex-col items-center mx-3 p-4 text-center shadow-md shadow-gray-200 transform transition-transform duration-300 hover:scale-105 max-w-xs ">
            <h3 className="font-Poppins text-lg font-bold text-white py-2">
              SYSTEM INTEGRATION
            </h3>
          ...
          <li className="flex flex-col items-center mx-3 p-4 text-center shadow-md shadow-gray-200 transform transition-transform duration-300 hover:scale-105 max-w-xs py-7">
            <h3 className="font-Poppins text-lg font-bold text-white py-2">
              IT SERVICES{" "}
            </h3>
            <p className="text-base text-white">
